...
export class TransactionService {
  ...
  async createTransaction(createTransactionDto: CreateTransactionDto) {
    ...
    const receipt_numbers = lastTransaction
    ...
    const transaction = await this.prisma.transaction.create({
      data: {
        ...
        user_id,
        order_type,
        receipt_number: receipt_number || receipt_numbers, // Use autogenerated receipt number if not provided
        sub_total,
        tax_id,
        grand_total,
        product_id,
        ...
        payment_type,
        change,
        customer_name: customer_name || null, // Handle optional fields
